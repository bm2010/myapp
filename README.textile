...
Preferences:
{:git=>true, :apps4=>"rails-devise", :unit_test=>false, :integration=>false, :fixtures=>false, :authentication=>"devise", :authorization=>false, :starter_app=>false, :quiet_assets=>true, :local_env_file=>true, :better_errors=>true, :dev_webserver=>"thin", :prod_webserver=>"thin", :database=>"sqlite", :templates=>"erb", :continuous_testing=>"guard", :frontend=>"bootstrap3", :email=>"smtp", :devise_modules=>"confirmable", :form_builder=>"simple_form", :rvmrc=>true, :ban_spiders=>true, :github=>true}
